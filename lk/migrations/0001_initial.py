    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status',
                 models.IntegerField(choices=[(0, 'Врач'), (1, 'Пациент'), (2, 'Тестировщик'), (3, 'Исследователь')],
                                     default=0)),
                ('exp', models.IntegerField(default=0)),
                ('isFull', models.BooleanField(default=False)),
                ('city', models.CharField(blank=True, max_length=50)),
                ('slug', models.SlugField(null=True)),
                ('avatar', models.ImageField(default='lk/static/images/toothless.jpg', upload_to='avatars')),
                (
